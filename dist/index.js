...
var require_lodash2 = __commonJS({
  "node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/index.js"(exports, module) {
    module.exports = require_lodash();
  }
});

// node_modules/.pnpm/use-canvas-image@0.0.7/node_modules/use-canvas-image/index.ts
var unifyArgs = (options) => {
  const result = {
    x: 0,
    y: 0,
    width: null,
...
var useCanvasImage = (image, callback, options) => {
...
var use_canvas_image_default = useCanvasImage;

// src/arePointsCollinear.ts
...
var arePointsCollinear_default = arePointsCollinear;

// src/simplifyDouglasPeucker.ts
...
var simplifyDouglasPeucker_default = simplifyDouglasPeucker;
...
var imageGbc = function(src, options) {
  return __async(this, null, function* () {
    const pxs = [];
    const pxsMap = /* @__PURE__ */ new Map();
    yield use_canvas_image_default(src, (e) => {
      pxs.push(e);
    ...
    const isBJ = ({ x, y, canvasWidth, canvasHeight, a }) => {
      return getZwPx(x, y).some((e) => {
        var _a;
        return ((_a = pxsMap.get(e.join())) == null ? void 0 : _a.a) === 0;
      }) || a !== 0 && (y === 0 || x === 0 || x === canvasWidth - 1 || y === canvasHeight - 1);
    };
    const pxsResultsMap = /* @__PURE__ */ new Map();
    ...
    const pxsLine = [];
    const pxsLineMap = /* @__PURE__ */ new Map();
    let curr = null;
    const calcNextCurr = (e) => {
      const { x, y } = e;
      const ps = getZwPx(x, y).map((e2) => pxsResultsMap.get(e2.join())).filter((e2) => e2 && !pxsLineMap.get([e2.x, e2.y].join()));
      return ps[0] || e;
    };
    ...
    pxsLine.forEach((e, k) => {
      if (dots.length < 3) {
        ...
        if (arePointsCollinear_default(dots.map((e2) => [e2.x, e2.y]))) {
          dots.push(e);
        } else {
    ...
    const tolerance = (0, import_lodash.get)(options, "tolerance", 0.1);
    return simplifyDouglasPeucker_default(newPxsLine, tolerance);
  });
};
var src_default = imageGbc;
export {
